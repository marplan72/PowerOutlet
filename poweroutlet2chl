...
# -*- coding: utf-8 -*-
#
# PROGRAMME.......: poweroutlet2chl.py
# VERSION.........: 1.0.0
# DATE DE CREATION: 2015-02-07
# DATE DE CREATION: 2015-02-07
# UTILISATION.....: Gestion des prise de courant avec un relay 2 channel
#
...
sListe = ["Socket s1", 
          "Socket s2"]
SleepTimeL = 0.2
sCfgFil = "/var/www/gpio2/poweroutlet.cfg"
...
# Si les parametres ne sont pas connus...
    ...
    wlog("Parametres attendus: sX ou X est le # de prise entre 1 et 2, [on/off]")
