...
# -*- coding: utf-8 -*-
#
# PROGRAMME.......: poweroutlet4chl.py
# VERSION.........: 1.0.0
# DATE DE CREATION: 2015-02-07
# DATE DE CREATION: 2015-02-07
# UTILISATION.....: Gestion des prises electriques avec un relay 4 channel
#
...
sListe = ["Socket s1", 
          ...
          "Socket s4"]
SleepTimeL = 0.2
sCfgFil = "/var/www/gpio4/poweroutlet.cfg"
...
# Si les parametres ne sont pas connus...
    ...
    wlog("Parametres attendus: sX ou X est le # de prise entre 1 et 4, [on/off]")
